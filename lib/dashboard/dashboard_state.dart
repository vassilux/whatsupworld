...
class UnDashboardState extends DashboardState {
  ...
  UnDashboardState(int version) : super(version);
...
class InDashboardState extends DashboardState {
  ...
  InDashboardState(int version, this.hello) : super(version, [hello]);
...
class ErrorDashboardState extends DashboardState {
  ...
  ErrorDashboardState(int version, this.errorMessage): super(version, [errorMessage]);
